...
def feature_section():
 imgs=FEATURE_IMGS
 photo_row=lambda a,b,alt_a,alt_b:f'<div class="wrap intro" style="align-items:start"><div class="intro-visual">{photo(imgs[a],alt_a)}</div><div class="intro-visual" style="padding-left:0">{photo(imgs[b],alt_b)}</div></div>'
