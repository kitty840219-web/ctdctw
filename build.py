...
page('shop.html','周邊商品',heading('周邊商品','SHOP')+'<section class="wrap" style="padding-bottom:100px"><p class="body-copy" style="margin-bottom:40px">CTDC 空間美學周邊，陸續上架中。</p><div id="shop-status"></div><div id="shop-grid" class="project-grid" aria-live="polite"><p class="empty">載入中…</p></div></section>')
page('product.html','商品詳情','<div class="wrap breadcrumb"><a href="shop.html">周邊商品</a> / <span id="product-crumb">商品詳情</span></div><section class="wrap contact-layout" id="product-detail" style="padding-bottom:100px" aria-live="polite"><p class="empty">載入中…</p></section>')
page('cart.html','購物車',heading('購物車','CART')+'<section class="wrap shop-checkout" style="padding-bottom:100px"><div id="cart-list" aria-live="polite"><p class="empty">載入中…</p></div><div id="cart-summary" class="cart-total" hidden><span>總金額</span><strong id="cart-total-amount">NT$0</strong></div><a class="text-link" id="checkout-link" href="checkout.html" style="margin-top:30px" hidden>前往結帳</a></section>')
page('checkout.html','結帳',heading('結帳','CHECKOUT')+'<section class="wrap shop-checkout" style="padding-bottom:100px"><div id="checkout-summary" aria-live="polite"><p class="empty">載入中…</p></div><form id="checkout-form" class="contact-form" hidden><div class="form-grid"><label class="form-field"><span>收件人姓名 *</span><input type="text" name="name" required></label><label class="form-field"><span>聯絡電話 *</span><input type="tel" name="phone" required></label><label class="form-field"><span>電子信箱 *</span><input type="email" name="email" required></label><label class="form-field"><span>收件地址 *</span><input type="text" name="address" required></label></div><label class="form-field" style="margin-bottom:26px"><span>備註</span><textarea name="note" rows="3"></textarea></label><div class="form-actions"><button type="submit">前往付款</button><p class="form-status" id="checkout-status" role="status"></p></div></form></section>')
